...
export default function ProjectsPage() {
  ...
  const { isManagerOrAdmin, user } = useRoleAccess();
  ...
  const handleEditProject = (project) => {
    ...
    // Edit modal'ını aç veya edit sayfasına yönlendir
  };
    ...
    if (
      ...
      try {
        ...
        if (response.ok) {
          ...
          dispatch(fetchProjects()); // Listeyi yenile
        } else {
    ...
    <DashboardLayout>
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {/* Yeni Proje Butonu - Sadece Manager/Admin */}
          <RoleBasedComponent allowedRoles={["Manager", "Admin"]}>
            <button
        ...
        <div className="mb-4 flex items-center space-x-2 text-sm text-gray-600">
          ...
          <span>
            {user?.role === "Admin" &&
              "Tüm projeleri görebilir ve yönetebilirsiniz"}
            {user?.role === "Manager" &&
              "Sahip olduğunuz ve üye olduğunuz projeleri görebilirsiniz"}
            {user?.role === "Developer" &&
              "Sadece üye olduğunuz projeleri görebilirsiniz"}
          </span>
        </div>
              ...
              <div className="col-span-full text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  filterPriority !== "all"
                    ...
                    : user?.role === "Developer"
                    ? "Henüz hiçbir projenin üyesi değilsiniz. Manager'lardan size proje ataması yapmasını isteyin."
